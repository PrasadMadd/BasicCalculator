...
var num1 = 0, num2 = 0, opr = "",
    divNumbers = document.querySelectorAll(" .box-num"),
    divOpers = document.querySelectorAll(" .box-opr"),
...
// calculation function to do the operations
